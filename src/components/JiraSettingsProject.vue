<template>
  <d-row gap block align="stretch" elevation="2">
    <d-column gap block>
      <d-textfield full-width v-model="modelValue.project" color="primary" filled label="Project Name" type="name"/>
      <d-card-subtitle class="py-0">
        Use repository name
      </d-card-subtitle>
      <d-textfield full-width v-model="modelValue.path" color="primary" filled label="Path" type="path"/>
      <d-card-subtitle class="py-0">
...
watch(() => props.modelValue, (data) => emit("update:modelValue", data))
</script>
